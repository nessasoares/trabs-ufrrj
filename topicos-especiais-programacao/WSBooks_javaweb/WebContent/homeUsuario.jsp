                ...
                <div id="team-carousel" class="carousel slide wow fadeIn" data-ride="carousel" data-wow-duration="400ms" data-wow-delay="400ms">
                    ...
                    <div class="carousel-inner">
                       ...
                       <!--     <div class="col-sm-3 col-xs-6">
                            ...
                            <c:forEach var = "livros" items = "${atualizacaoLivroCarrossel1}" >
                            
                            <div class="col-sm-3 col-xs-6 wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
			                    <div class="team-single-wrapper">   
			                        <div class="team-single">
			                            <div class="person-thumb">
			                                <img src="multicolor-4/images/books/${livros.arquivo}" class="img-responsive" alt="">
			                            </div>
			                            <div class="social-profile">
			                                <ul class="nav nav-pills">
			                                    <li><a href="multicolor-4/images/books/${livros.arquivo}" data-lightbox="example-set"><i id="heart" class="fa fa-eye"></i></a></li>
			                                </ul>
			                            </div>
			                        </div>
			                        <div class="portfolio-info">
			                              <h2>${livros.titulo}</h2>
			                              <p>${livros.autor}</p>                  </div>
			                    </div>
			                </div>
                        ...
                        <div class="item">
                           ...
                           <c:forEach var = "livros2" items = "${atualizacaoLivroCarrossel2}" >
                             <div class="col-sm-3 col-xs-6 wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
			                    <div class="team-single-wrapper">   
			                        <div class="team-single">
			                            <div class="person-thumb">
			                                <img src="multicolor-4/images/books/${livros2.arquivo}" class="img-responsive" alt="">
			                            </div>
			                            <div class="social-profile">
			                                <ul class="nav nav-pills">
			                                    <li><a href="multicolor-4/images/books/${livros2.arquivo}" data-lightbox="example-set"><i id="heart" class="fa fa-eye"></i></a></li>
			                                </ul>
			                            </div>
			                        </div>
			                        <div class="portfolio-info">
			                              <h2>${livros2.titulo}</h2>
			                              <p>${livros2.autor}</p>                  </div>
			                    </div>
			                </div>
                            </c:forEach>
        ...
        <div class="vertical-center sun">
             <div class="container">
                <div class="row">
                    <div class="action">
                        <div class="col-sm-12">
                            <h1 class="title">Livros Mais Procurados</h1>
...
<section id="services">
        <div class="container">
          <!--    <h2><img src="multicolor-4/images/portfolio/icon.png" alt=""> LIVROS</h2>-->
            ...
            <div class="row">
             <c:forEach var = "visitados" items = "${livrosMaisVistos}" >
            	<div class="col-sm-4 text-center maisVisitados wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
                    <div class="single-service">
                        <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="300ms">
                        <c:set var="idval" value="${visitados.id}"/> 
                        <a href=servletDetalhaLivro?id=<c:out value="${idval}"/>>
                        <img id="mV" src="multicolor-4/images/books/${visitados.arquivo}" class="img-responsive" alt=""></a>
                        </div>
                        
                        <div class="person-info">
                            <p id="textP">${visitados.titulo}</p>
                            <p id="textP">${visitados.autor}</p>
                        </div>
                    </div>
                </div>
            </c:forEach>
