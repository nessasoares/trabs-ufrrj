...
<head>
    ...
    <title>Cadastro Usuário| WS book's</title>
    ...
    <!--/#page-breadcrumb-->
       ...
       <div class="row mt">
		...
		<c:if test="${msgsAlert eq '1'}">
        	...
        	swal({   title: "Good job!",   text: msg,   type: "success",   confirmButtonText: "Ok"},
        	function(){
        	    window.location.href = '/RecomendacaoLivros/index.html';
        	});
        	</script>
        </c:if>
        ...
        <c:if test="${msgsAlert eq '3'}">
        	...
        	<script>
        	msg = "USERNAME EXISTENTE!";
        	swal({   title: "Aviso!",   text: msg,   type: "warning",   confirmButtonText: "Ok"});
        	</script>
        </c:if>
        
        <c:if test="${msgsAlert eq '4'}">
         ...
         <c:if test="${msgsAlert eq '5'}">
       
        	<script>
        	msg ="A senha deve ter no mínimo 6 dígitos";
        	swal({   title: "Aviso!",   text: msg,   type: "warning",   confirmButtonText: "Ok"});
        	</script>
        </c:if>
