class LivrosController < ApplicationController
  before_action :set_livro, only: [:show, :edit, :update, :destroy, :search, :curtir]
  ...
  def destroy
    @livro.destroy
    respond_to do |format|
      format.html { redirect_to homeUser_path, notice: 'Livro was successfully destroyed.' }
  ...
  private
    ...
    def livro_params
      params.require(:livro).permit(:titulo, :autor, :editora, :ano, :sinopse, :image, :visita)
    end
end
