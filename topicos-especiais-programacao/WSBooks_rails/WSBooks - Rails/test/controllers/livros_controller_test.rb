...
class LivrosControllerTest < ActionController::TestCase
  ...
  test "should create livro" do
    assert_difference('Livro.count') do
      post :create, livro: { ano: @livro.ano, autor: @livro.autor, editora: @livro.editora, sinopse: @livro.sinopse, titulo: @livro.titulo }
    end
  ...
  test "should update livro" do
    patch :update, id: @livro, livro: { ano: @livro.ano, autor: @livro.autor, editora: @livro.editora, sinopse: @livro.sinopse, titulo: @livro.titulo }
    assert_redirected_to livro_path(assigns(:livro))
  end
