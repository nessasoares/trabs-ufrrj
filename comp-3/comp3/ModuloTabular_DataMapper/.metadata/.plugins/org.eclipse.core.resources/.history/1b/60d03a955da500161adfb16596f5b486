...
<%@ page import = "controladores.ambiente.*" %>
<%@ page import = "controladores.mobilia.*" %>
<%@ page import = "controladores.contrato.*" %>
...
<body>
 <div class="col-lg-3 col-lg-offset-4" >
	...
	<form method="post" action="CriarAmbiente" id="create_form">
        ...
        for (Comodo c: l) {
             for(Mobilia u: sl.listaMobiliaComodo(c.getId())){
		...
		<div class="col-lg-10 col-lg-offset-2">
		    ...
		    <a class="btn btn-success" onclick="getMobilias()">Submit</a>
		</div>
	</form>
</div>
</center>
