 ...
 * Generated at: 2016-11-08 00:02:36 UTC
...
import servicelayer.comodo.*;
import md.*;
import java.util.*;
import dao.ComodoDAO;

public final class CriarComodo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_packages.add("servicelayer.comodo");
    _jspx_imports_packages.add("javax.servlet.jsp");
    _jspx_imports_classes = new java.util.HashSet<>();
    _jspx_imports_classes.add("dao.ComodoDAO");
  }
...
return;
    ...
    try {
      ...
      out.write("\t\t$('#tipoComodo').on('change', function() {\n");
      out.write("\t\t\t  if( this.value == \"ComodoComposto\"){\n");
      out.write("\t\t\t\t  $('#comodosCC').show();\n");
      out.write("\t\t\t\t  this.value = \"ComodoComposto\";\n");
      out.write("\t\t\t  } else{\n");
      out.write("\t\t\t\t  $('#comodosCC').hide();\n");
      out.write("\t\t\t  }\n");
      out.write("\t\t\t});\n");
      out.write("\t});\n");
      out.write("\t\n");
      out.write("\tfunction getComodos(){\n");
      ...
      out.write("\t<h3><center><font face=\"Calibri\" color=\"gray\">Estilo:</font> </center></h3>\n");
      out.write("\t<h5><center><font face=\"Calibri\" color=\"gray\">Personalize seu cômodo!</font> </center></h5><br>\n");
      out.write("\t\t\n");
      out.write("\t<form method=\"post\" action=\"CriarComodo\">\n");
      out.write("\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t  <input class=\"form-control\" name=\"descricao\" id=\"descricao\" type=\"text\" placeholder=\"Descrição do comodo\">\n");
      out.write("\t\t\t  </div>\n");
      out.write("\t\t\t  <div style=\"margin-bottom:3%;margin-left:3%;\">\n");
      out.write("\t\t\t  <label>Tipo de cômodo:</label>\n");
      out.write("\t\t\t  <select name =\"tipoComodo\" id=\"tipoComodo\">\n");
      out.write("\t\t\t  \t<option value=\"Quarto\">Quarto</option>\n");
      out.write("\t\t\t  \t<option value=\"Sala\">Sala</option>\n");
      out.write("\t\t\t  \t<option value=\"Cozinha\">Cozinha</option>\n");
      out.write("\t\t\t  \t<option value=\"ComodoComposto\">Comodo Composto</option>\n");
      out.write("\n");
      out.write("\t\t\t  </select>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div id=\"comodosCC\" style=\"margin-bottom:3%;display:none;\" >\n");
      out.write("\t\t\t<h5>Escolha os cômodo:</h5>\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t<!--\"<td><div class='checkbox'><label>\"\n");
      out.write("\t\t\t\t\t\t+\"<input class='checkbox' name='comodos' id='\"+ u.getId()\n");
      out.write("\t\t\t\t\t\t+ \"' type='checkbox' style='margin-bottom:3%;' value =\" +u.getId() +\" >\"\n");
      out.write("\t\t\t\t\t\t+ u.getDescricao()+\"</label></div></td>\n");
      out.write("\t\t\t\t-->\n");
      out.write("\t\t\t\t<tbody>\n");
      out.write("\t\t\t\t\t");
      ...
      out.write("\t\t        <button type=\"submit\" onclick='getComodos()' class=\"btn btn-success\">Submit</button>\n");
      out.write("\t        </div>\n");
      out.write("\t</form>\n");
      out.write("</div>\n");
      out.write("</center>\t\n");
