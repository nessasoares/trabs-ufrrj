...
<%@ page import = "DomainModel_ActiveRecord.*" %>
...
<body>
 <div class="col-lg-3 col-lg-offset-4" >
	...
	<form method="post" action="CriarAmbiente" id="create_form" onsubmit="return isValidForm()">
        ...
        <%
        List<ComodoMD> l = (List<ComodoMD>)request.getAttribute("comodos");
		 HashSet<String> hash = new HashSet<>();
		 CriarContrato_SL sl = new CriarContrato_SL();
        for (ComodoMD c: l) {
             for(MobiliaMD u: MobiliaMD.listarMobiliaComodo(c.getId())){
