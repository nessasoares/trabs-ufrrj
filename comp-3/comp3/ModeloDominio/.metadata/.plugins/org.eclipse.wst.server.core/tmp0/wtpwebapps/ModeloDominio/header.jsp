	...
	<link href="js/jquery-latest.min.js" rel="stylesheet"/>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="CriarComodo">Criar</a></li>
            <li><a href="ListarComodo">Listar</a></li>
          </ul>
        </li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Mobília<span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            <li><a href="CriarMobilia">Criar</a></li>
            <li><a href="ListarMobilia">Listar</a></li>
          </ul>
        </li>
        <li class="dropdown">
		...
		<li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li><a href="ListarAmbiente">Listar</a></li>
          </ul>
        </li>
