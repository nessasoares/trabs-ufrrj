 ...
 * Generated at: 2016-11-06 23:39:45 UTC
...
public final class ListarAmbientesContrato_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("entidades.Ambiente");
  }
...
return;
    ...
    try {
      ...
      out.write("\t\t\t $('input[name=\"method\"]').val(\"cancel\");\t\n");
      out.write("\t});\n");
      out.write("});\n");
      out.write("</script>\n");
      out.write("<body>\n");
      ...
      out.write("\t\t<form method=\"post\" action=\"FinalizarContrato\" id='list_form'>\n");
      out.write("\t\t\n");
      out.write("\t\t  <input class=\"form-control\" name=\"comissao\" min=\"0.01\" id=\"comissao\" step=0.01 type=\"number\" placeholder=\"Comissão\" style='margin-bottom:3%;width:97%;' required>\n");
      ...
      out.write("\n");
      out.write("\t<input type='hidden' name='idAmbiente' id='idAmbiente'/>\n");
      out.write("\t<input type='hidden' value='' name='method' id='method'>\n");
      out.write("\t\n");
      out.write("\t<div style=\"width:130%\">\n");
      out.write("\t\t<a class=\"btn btn-primary\"  href=\"CriarAmbiente\">Criar Outro Ambiente</a>\n");
      out.write("        <button type=\"submit\" class=\"btn btn-primary\" id='cancelBtn'>Excluir</button>\n");
      out.write("\t\t<button type=\"submit\" class=\"btn btn-success\">Finalizar Contrato</button>\n");
      out.write("\t\t\n");
      out.write("\t\t\n");
      out.write("\t</div>\n");
      out.write("\t</form>\n");
