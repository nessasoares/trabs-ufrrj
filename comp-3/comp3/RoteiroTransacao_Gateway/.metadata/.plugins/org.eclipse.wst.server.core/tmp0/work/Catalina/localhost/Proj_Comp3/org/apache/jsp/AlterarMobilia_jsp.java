 ...
 * Generated at: 2016-11-06 23:01:50 UTC
    ...
    try {
      ...
      out.write("\t\t\t  ");
			 	...
			 	out.println("<input class='form-control' name='desc' id='desc' value='"+request.getParameter("desc") +"'");
			  	...
			  	out.println("<input class='form-control' name='custo' id='custo' value='"+request.getParameter("custo") +"'");
			  	out.println(" style='margin-bottom:3%;' placeholder='custo' type='number' step=0.01 >");
			  	out.println("<input class='form-control' name='tempoEntrega' id='tempoEntrega' value='"+request.getParameter("tempo") +"'");
