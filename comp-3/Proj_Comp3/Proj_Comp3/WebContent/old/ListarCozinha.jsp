...
<%@ page import = "controladores.CrListarCozinha" %>
<%@ page import = "entidades.Cozinha" %>
<%@ page import = "singleton.Singleton" %>
<%@ page import = "dao.CozinhaDAO" %>
...
<tbody>
	<form method="post" action="CrListarCozinha" id='list_form'>
	<%  
		for(Cozinha u: CozinhaDAO.listaCozinha() ){
			out.println("<tr>");
