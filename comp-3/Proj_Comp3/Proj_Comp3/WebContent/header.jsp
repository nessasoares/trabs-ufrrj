      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="CriarComodo.jsp">Criar</a></li>
            <li><a href="ListarComodo.jsp">Listar</a></li>
          </ul>
        </li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Mobília<span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            <li><a href="CriarMobilia.jsp">Criar</a></li>
            <li><a href="ListarMobilia.jsp">Listar</a></li>
          </ul>
        </li>
      </ul>
