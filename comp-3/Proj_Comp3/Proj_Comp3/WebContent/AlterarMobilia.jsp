...
<body>
 <div class="col-lg-3 col-lg-offset-4" >
	<h3><center><font face="Calibri" color="gray">Edição:Mobilia</font> </center></h3>
		...
		<form method="post" action="CrAlterarMobilia">
			<div class="form-group">
			  ...
			  <%
			 	out.println("<input class='form-control' name='desc' id='desc' value=''");
			  	...
			  	out.println("<input class='form-control' name='custo' id='custo' value=''");
			  	out.println(" style='margin-bottom:3%;' placeholder='custo' type='number' step=0.01 >");
			  	out.println("<input class='form-control' name='tempoEntrega' id='tempoEntrega' value=''");
